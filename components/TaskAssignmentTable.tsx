                             ...
                             <tr key={task.id} onClick={() => setSelectedTaskId(task.id)} className="group hover:bg-slate-50/80 transition-colors cursor-pointer">
                                 ...
                                 <td className="px-4 py-4 align-top">
                                     ...
                                     <div className="flex items-center gap-2 text-xs text-slate-500 mb-2">
                                         <span className="flex items-center gap-1 whitespace-nowrap"><CalendarIcon size={12}/> {new Date(order.eventDate).toLocaleDateString()}</span>
                                     </div>
                                 ...
                                 <td className="px-4 py-4 align-top" onClick={e => e.stopPropagation()}>
                                     <div className="relative">
                                        ...
                                        <select 
                                            className={`w-full pl-6 pr-2 py-1.5 rounded text-xs font-bold outline-none border cursor-pointer appearance-none ${
                                                order.paymentStatus === '已付清' ? 'bg-green-50 text-green-700 border-green-200' :
